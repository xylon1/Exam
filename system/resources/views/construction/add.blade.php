...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <form action="{{route('construction.save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="manpower_id">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="investment_range">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-2 col-form-label">Investment Type</label>
                        <div class="col-10">
                            <input class="form-control" type="text" name="investment_type_id">
                        </div>
                    </div>
